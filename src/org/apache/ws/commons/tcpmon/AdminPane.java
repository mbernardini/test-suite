...
import com.lp.model.Model;
import com.lp.view.ClientConnectionPanel;
...
class AdminPane extends JPanel {
   public static final int DEFAULT_LISTEN_PORT = 8080;
     ...
     */
    public JRadioButton listenerButton, proxyButton, clientButton;
    ...
    public AdminPane(JTabbedPane notebook, String name) {
        ...
        mainPane.add(new JLabel("Create a new listening socket..."), c);
        ...
        c.anchor = GridBagConstraints.WEST;
        c.gridwidth = GridBagConstraints.REMAINDER;
        mainPane.add(new JLabel(TCPMonitor.getMessage("actAs00", "Act as a...")), c);

        // Listener Selection
        // /////////////////////////////////////////////////////////////////
        c.anchor = GridBagConstraints.WEST;
        c.gridwidth = GridBagConstraints.REMAINDER;
        final String listener = TCPMonitor.getMessage("listener00", "Listener");
        ...
        tmpPanel.add(new JLabel(TCPMonitor.getMessage("listenPort00",
                "Listen Port #")
                + " "), c);
        c.anchor = GridBagConstraints.WEST;
        c.gridwidth = GridBagConstraints.REMAINDER;
        tmpPanel.add(port = new NumberField(4), c);
        port.setValue(DEFAULT_LISTEN_PORT);
        ...
        mainPane.add(clientButton = new JRadioButton(client), c);
        ...
        mainPane.add(hostLabel =
                new JLabel("Device IP"), c);
        c.anchor = GridBagConstraints.WEST;
        c.gridwidth = GridBagConstraints.REMAINDER;
        host = new HostnameField(30);
        mainPane.add(host, c);
        host.setText(Model.INSTANCE.getHostAddress());
        c.anchor = GridBagConstraints.WEST;
        c.gridwidth = 1;
        mainPane.add(Box.createRigidArea(new Dimension(25, 0)));
        mainPane.add(tportLabel =
                new JLabel( "Device Port #"), c);
        c.anchor = GridBagConstraints.WEST;
        c.gridwidth = GridBagConstraints.REMAINDER;
        tport = new NumberField(4);
        mainPane.add(tport, c);
        tport.setValue(TCPMonitor.DEFAULT_PORT);
        ...
        c.anchor = GridBagConstraints.WEST;
        c.gridwidth = GridBagConstraints.REMAINDER;
        final String proxy = TCPMonitor.getMessage("proxy00", "Proxy");
        ...
        opts.setBorder(new TitledBorder(TCPMonitor.getMessage("options00",
                "Options")));
        c.anchor = GridBagConstraints.WEST;
        c.gridwidth = GridBagConstraints.REMAINDER;
        mainPane.add(opts, c);
        ...
        c.anchor = GridBagConstraints.WEST;
        c.gridwidth = GridBagConstraints.REMAINDER;
        final String proxySupport = TCPMonitor.getMessage("proxySupport00",
                "HTTP Proxy Support");
        opts.add(HTTPProxyBox = new JCheckBox(proxySupport), c);
        c.anchor = GridBagConstraints.WEST;
        c.gridwidth = 1;
        opts.add(HTTPProxyHostLabel =
                new JLabel(TCPMonitor.getMessage("hostname00", "Hostname") + " "),
                c);
        ...
        opts.add(HTTPProxyPortLabel =
                new JLabel(TCPMonitor.getMessage("port00", "Port #") + " "), c);
        ...
        c.anchor = GridBagConstraints.WEST;
        c.gridwidth = GridBagConstraints.REMAINDER;
        final String delaySupport = TCPMonitor.getMessage("delay00",
        ...
        c.anchor = GridBagConstraints.WEST;
        c.gridwidth = 1;
        delayBytesLabel = new JLabel(TCPMonitor.getMessage("delay01",
                "Bytes per Pause"));
        ...
        c.anchor = GridBagConstraints.WEST;
        c.gridwidth = 1;
        delayTimeLabel = new JLabel(TCPMonitor.getMessage("delay02",
        ...
        c.anchor = GridBagConstraints.WEST;
        c.gridwidth = GridBagConstraints.REMAINDER;
        final String add = TCPMonitor.getMessage("add00", "Add");
            ...
            public void actionPerformed(ActionEvent event) {
                if (add.equals(event.getActionCommand())) {
                   if(clientButton.isSelected()){
                     ClientConnection cc = new ClientConnection(host.getText(),  tport.getValue(0));
                     Model.INSTANCE.addClientConnection(cc);
                     noteb.addTab("Connection", new ClientConnectionPanel(cc));
                   }
                   else{
                    String text;
                    Listener l = null;
